![CI](https://github.com/<A3FPRO_lab>/vireon-trp-time/actions/workflows/ci.yml/badge.svg)
...
Documentation / TRP framework text: CC BY 4.0 (see LICENSE-DOCS)



# Vireon_TRP_Time
 Canonical Vireon time framework: T = R × P with KL leash + falsifiers.
